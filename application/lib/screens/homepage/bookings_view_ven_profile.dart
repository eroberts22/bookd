...
class BookingViewProfile extends StatefulWidget {

  const BookingViewProfile({ Key? key }) : super(key: key);
  //final String uid;
  //const ProfileVenue(this.uid);
  
  @override
  State<BookingViewProfile> createState() => _BookingViewProfileState();
}

class _BookingViewProfileState extends State<BookingViewProfile> {
